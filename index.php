                ...
                <nav class="header-nav" aria-label="Navigation principale" role="navigation">
                    <ul class="nav-list">
                        ...
                        if (isset($_SESSION['id'])) {
                            echo '<li><a href="/deconnexion" class="btn btn-outline nav-cta">Déconnexion</a></li>';
                            echo '<li><a href="/calendrier" class="btn btn-primary nav-cta">Mon calendrier</a></li>';
                        } else {
                            echo '<li><a href="/connexion" class="btn btn-outline nav-cta">Connexion</a></li>';
                            echo '<li><a href="/inscription" class="btn btn-primary nav-cta">S\'inscrire</a></li>';
                        }
                        ?>
                    </ul>
                </nav>
        ...
        <div class="container">
            <div class="hero-content text-center">
                ...
                <div class="hero-cta flex justify-center gap-4 animate-slide-up">
                    <a href="/inscription" class="btn btn-primary btn-large">Essayer maintenant</a>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="feature-card animate-slide-up">
                    ...
                    <p class="feature-description">Ajoutez, modifiez et suivez vos événements en un clin d'œil grâce à
                        une <a href="/calendrier">interface intuitive</a>.</p>
                </div>
                <div class="feature-card animate-slide-up">
                    <div class="feature-icon">
                ...
                <div class="about-text max-w-2xl mx-auto">
                    ...
                    <div class="about-features grid md:grid-cols-2 gap-6 animate-slide-up">
                        <div class="feature-item">
                            ...
                            <p class="text-sm"><a href="/connexion">Interface intuitive</a> et personnalisable</p>
                        </div>
                        <div class="feature-item">
                    ...
                    <a href="/inscription" class="btn btn-primary btn-large mt-8 animate-slide-up">Commencer
                        maintenant</a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="cta-content text-center">
                ...
                <p class="section-subtitle animate-slide-up">Rejoignez des milliers d'utilisateurs qui planifient mieux
                    avec AgendDAY.</p>
                <a href="/inscription" class="btn btn-primary btn-large animate-slide-up">S'inscrire maintenant</a>
            </div>
        </div>
    </section>
            ...
            <div class="footer-content flex justify-between flex-wrap gap-8">
                ...
                <div class="footer-links">
                    ...
                    <ul class="text-sm">
                        ...
                        <li><a href="/politique-confidentialite" class="form-link">Politiques de
